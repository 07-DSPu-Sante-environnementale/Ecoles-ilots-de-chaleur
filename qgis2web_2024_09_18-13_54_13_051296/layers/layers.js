...
var format_Rseaulocaldesant_1 = new ol.format.GeoJSON();
var features_Rseaulocaldesant_1 = format_Rseaulocaldesant_1.readFeatures(json_Rseaulocaldesant_1, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Rseaulocaldesant_1 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Rseaulocaldesant_1.addFeatures(features_Rseaulocaldesant_1);
var lyr_Rseaulocaldesant_1 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Rseaulocaldesant_1, 
                style: style_Rseaulocaldesant_1,
                popuplayertitle: "Réseau local de santé",
                interactive: false,
                title: '<img src="styles/legend/Rseaulocaldesant_1.png" /> Réseau local de santé'
            });
var format_lotsdechaleur_2 = new ol.format.GeoJSON();
var features_lotsdechaleur_2 = format_lotsdechaleur_2.readFeatures(json_lotsdechaleur_2, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_lotsdechaleur_2 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_lotsdechaleur_2.addFeatures(features_lotsdechaleur_2);
var lyr_lotsdechaleur_2 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_lotsdechaleur_2, 
                style: style_lotsdechaleur_2,
                popuplayertitle: "Îlots de chaleur",
                interactive: false,
    title: 'Îlots de chaleur<br />\
    <img src="styles/legend/lotsdechaleur_2_0.png" /> Chaud<br />\
    <img src="styles/legend/lotsdechaleur_2_1.png" /> Très chaud<br />'
        });
...
lyr_GoogleSatellite_0.setVisible(true);lyr_Rseaulocaldesant_1.setVisible(true);lyr_lotsdechaleur_2.setVisible(true);lyr_colespubliques_3.setVisible(true);
var layersList = [lyr_GoogleSatellite_0,lyr_Rseaulocaldesant_1,lyr_lotsdechaleur_2,lyr_colespubliques_3];
lyr_Rseaulocaldesant_1.set('fieldAliases', {'RLS_code': 'RLS_code', 'RLS_nom': 'RLS_nom', 'RTS_code': 'RTS_code', 'RSS_code': 'RSS_code', 'RUIS_code': 'RUIS_code', 'Etiquette': 'Etiquette', 'Version': 'Version', 'SHAPE_Leng': 'SHAPE_Leng', 'SHAPE_Area': 'SHAPE_Area', });
lyr_lotsdechaleur_2.set('fieldAliases', {'DN': 'DN', });
...
lyr_Rseaulocaldesant_1.set('fieldImages', {'RLS_code': 'TextEdit', 'RLS_nom': 'TextEdit', 'RTS_code': 'TextEdit', 'RSS_code': 'TextEdit', 'RUIS_code': 'TextEdit', 'Etiquette': 'TextEdit', 'Version': 'TextEdit', 'SHAPE_Leng': 'TextEdit', 'SHAPE_Area': 'TextEdit', });
lyr_lotsdechaleur_2.set('fieldImages', {'DN': 'Range', });
...
lyr_Rseaulocaldesant_1.set('fieldLabels', {'RLS_code': 'no label', 'RLS_nom': 'no label', 'RTS_code': 'no label', 'RSS_code': 'no label', 'RUIS_code': 'no label', 'Etiquette': 'no label', 'Version': 'no label', 'SHAPE_Leng': 'no label', 'SHAPE_Area': 'no label', });
lyr_lotsdechaleur_2.set('fieldLabels', {'DN': 'no label', });
